  ...
  <div class="col-md-12 col-xl-10 mx-auto animated fadeIn delay-2s">
    <div class="card m-b-30">
      ...
      <div class="card-body">
          ...
          <div class="form-group">
            <label>Visi</label>
            <textarea class="form-control text-editor" rows="3" data-original-label="visi" name="visi"></textarea>
            <div id="visi"></div>
          </div>

          <div class="form-group">
            <label>Misi</label>
            <input type="text" class="form-control form-control-sm" placeholder="Misi" name="misi" id="misi">
          </div>
