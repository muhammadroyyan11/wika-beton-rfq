    ...
    <div class="card m-b-30">
      ...
      <div class="card-body">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control form-control-sm" placeholder="Name company" name="name_company" id="name_company">
          </div>

          <div class="form-group">
            <label>Desc company</label>
            <textarea class="form-control form-control-sm" placeholder="Desc company" name="desc_company" id="desc_company" rows="3" cols="80"></textarea>
          </div>

          <div class="form-group">
            <label>Visi</label>
            <textarea class="form-control form-control-sm" placeholder="Visi" name="visi" id="visi" rows="3" cols="80"></textarea>
          </div>

          <div class="form-group">
            <label>Misi</label>
            <textarea class="form-control form-control-sm" placeholder="Misi" name="misi" id="misi" rows="3" cols="80"></textarea>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="input-group col-xs-12">
              ...
              <input type="text" class="form-control form-control-sm file-upload-info file-name" data-id="img_logo" placeholder="Img logo" readonly name="img_logo" />
          ...
          <div class="form-group">
            ...
            <div class="input-group col-xs-12">
              ...
              <input type="text" class="form-control form-control-sm file-upload-info file-name" data-id="img_desc" placeholder="Img desc" readonly name="img_desc" />
            <span class="input-group-append">
          ...
          <div class="form-group">
            ...
            <div class="input-group col-xs-12">
              ...
              <input type="text" class="form-control form-control-sm file-upload-info file-name" data-id="img_header" placeholder="Img header" readonly name="img_header" />
            <span class="input-group-append">
