      ...
      <div class="card">
        <div class="card-header">
          ...
          <div class="pull-right">
                          <a href="<?=url("footer_alamat_cabang/add")?>" class="btn btn-success btn-flat"><i class="fa fa-file btn-icon-prepend"></i> Add</a>
          ...
          <div class="card-body card-dashboard">
            <form autocomplete="off" class="content-filter">
              <div class="row">
                                  ...
                                  <div class="form-group col-md-6">
                                          <input type="text" id="streets" class="form-control form-control-sm" placeholder="Streets" />
                                      </div>
...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    table = $('#table').DataTable({
      ...
      "ajax": {
        "url": "<?= url("footer_alamat_cabang/json")?>",
        "type": "POST",
         "data": function(data) {
                                          data.name = $("#name").val();
                                                        data.description = $("#description").val();
                                                        data.streets = $("#streets").val();
                                    }
              },
