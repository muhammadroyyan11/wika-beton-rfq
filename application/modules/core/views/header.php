      ...
      <div class="navbar-container content">
        <div class="navbar-collapse" id="navbar-mobile">
          ...
          <ul class="nav navbar-nav float-right">
            ...
            <li class="dropdown dropdown-notification nav-item"><a class="nav-link nav-link-label" href="#" data-toggle="dropdown"><i class="ficon feather icon-bell"></i><span class="badge badge-pill badge-primary badge-up count_notif" id="count_notif"></span></a>
              <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right" id="messages_notif">
                <li class="dropdown-menu-header">
                  <div class="dropdown-header m-0 p-2">
                    <h3 class="white count_notif" id="count_notif"></h3><span class="grey darken-2">App Notifications</span>
                  </div>
                </li>
