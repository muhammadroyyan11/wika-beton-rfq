                ...
                <form action="<?= $action ?>" id="form" autocomplete="off">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control form-control-sm" placeholder="Name portfolio"
                            name="name_portfolio" id="name_portfolio" value="<?= $name_portfolio ?>">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control form-control-sm" placeholder="Desc portfolio" name="desc_portfolio" id="desc_portfolio"
                            rows="3" cols="80"><?= $desc_portfolio ?></textarea>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group col-xs-12">
                            ...
                            <input type="text" class="form-control form-control-sm file-upload-info file-name"
                                data-id="image" placeholder="Image" readonly name="image" value="<?= $image ?>" />
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control form-control-sm" placeholder="Client name"
                            name="client_name" id="client_name" value="<?= $client_name ?>">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control form-control-sm" placeholder="Project date"
                            name="project_date" id="project_date" value="<?= $project_date ?>">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select name="pic" class="form-control">
                            ...
                            <?php $selected = isset($item['nama']) && $item['nama'] == $pic ? 'selected' : ''; ?>
                            <option value="<?= isset($item['nama']) ? $item['nama'] : '' ?>" <?= $selected ?>>
                                <?= isset($item['nama']) ? $item['nama'] : '------ pilih pic ----------' ?>
                            </option>
                            <?php } ?>
                        </select>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select name="jabatan" class="form-control">
                            ...
                            <?php foreach ($pimpinan as $item) { ?>
                            <?php $selected = isset($item['jabatan']) && $item['jabatan'] == $jabatan ? 'selected' : ''; ?>
                            <option value="<?= isset($item['jabatan']) ? $item['jabatan'] : '' ?>" <?= $selected ?>>
                                <?= isset($item['jabatan']) ? $item['jabatan'] : '------ pilih jabatan ----------' ?>
                            </option>
                            <?php } ?>
                        </select>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control form-control-sm" placeholder="Rate facility"
                            name="rate_facility" id="rate_facility" value="<?= $rate_facility ?>">
                    </div>
